...
bool bdbool(bool *binding) { return (bool)binding; }
...
int bdint(int *binding) { return (int)binding; }
...
void print(int indent, int subject) { printf("%d", subject); }

void clint(int subject) {}

long bdlong(long *binding) { return (long)binding; }
...
void prlong(int indent, long subject) { printf("%ld", subject); }

void cllong(long subject) {}

string bdstring(string *binding) { return (string)binding; }
...
void *bdvoid(void **binding) { return NULL; }

bool mtvoid(void *pattern, void *subject) { return False; }

void frvoid(void **source) {}
void fdvoid(void **source) {}

void prvoid(int indent, void *source) { printf("(void)"); }
